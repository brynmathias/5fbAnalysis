...
for cut in Cuts:
  for model in models:
      ...
      c1 = Print("./out/LepVeto_SMS%s.pdf"%(model))
      c1.DoPageNum = False
      c1.open()
      ...
      print model, cut
      FullCutFlowRootFile100 = r.TFile.Open("./LepVetoOnSignalFiles/results_NEWSCAN_had_%s_100.root"%(model))
      NMinus1RootFile100 = r.TFile.Open("./LepVetoOnSignalFiles/results_NEWSCAN_had_%s_100.root"%(model))
      ...
      for bin in settings["HTBins"]:        
          ...
          NMinus1 = GetHist(File = NMinus1RootFile100,folder = ["smsScan_noOddLep_AlphaT55_375_475","smsScan_noOddLep_AlphaT55_475_575","smsScan_noOddLep_AlphaT55_575_675",
      "smsScan_noOddLep_AlphaT55_675_775","smsScan_noOddLep_AlphaT55_775_875","smsScan_noOddLep_AlphaT55_875"],hist = "m0_m12_mChi_noweight", Norm = None ,rebin= 2).Clone()
          ...
          oneD = r.TH1D("OneD_Projection","",500,0,0.05)
          for a in l:
            for b in l:
              # m_sq (m_gl) - m_LSP >= 175 && m_sq (m_gl) >= 300
          ...
          closeBins = []
          farBins = []
          closeToLine = r.TH1D("OneD_Projection_closeToLine","",200,0,0.02)
          farToLine = r.TH1D("OneD_Projection_farToLine","",200,0,.02)
          line = 350.
          cutoff = 450.
          # if model == "T1tttt":
          #   line = 550.
